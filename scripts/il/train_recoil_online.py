...
from cleanil.il import recoil_online
...
def main():
    ...
    algo_config = recoil_online.RECOILOnlineConfig(**config["algo"])
    ...
    train_transform = ObservationNorm(
        obs_mean, obs_std, 
        in_keys=["observation"], out_keys=["observation"],
        standard_normal=True,
    )
    eval_transform = ObservationNorm(
        obs_mean, obs_std, 
        in_keys=["observation"], out_keys=["observation"],
        standard_normal=True,
    )
    train_env.append_transform(train_transform)
    eval_env.append_transform(eval_transform)
